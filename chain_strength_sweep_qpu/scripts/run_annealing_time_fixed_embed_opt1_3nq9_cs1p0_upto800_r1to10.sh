...
SWEEP_ROOT="$ROOT/annealing_time_sweep_qpu_fixedemb_v113_opt1_3nq9_cs1p0_upto800_r1to10"
...
# Fixed penalty/embedding source (same as BO-best case)
...
# Requested fixed chain strength
CS_3NQ9="1.0"

# Annealing-time sweep grid (us): same style, capped at 800
ANNEAL_TIMES=(0.5 1 2 5 10 20 50 100 200 500 800)
...
# Snapshot exact BO case into local work root.
rm -rf "$WORK_ROOT/$CASE_3NQ9"
...
MANIFEST="$RESULT_DIR/anneal_time_fixedemb_opt1_3nq9_cs1p0_upto800_r1to10_manifest_${STAMP}.csv"
