...
class Ligand():
    def __init__(self,path,pdbqt_dir_path):
        ...
        self.d_matrix =squareform(pdist(self.coords)) # intraligand distances
    ...
    def read_pdbqt(self):
        coords = [] # ligand.coords represents r_i
        qs = []
        autodock_atom_types = [] # ligand.autodock_atom_types represents a_i
...
'''
Generate and read ligand PDBQT files, then compute coordinates, charges,
and the distance matrix used by the manuscript's ligand preprocessing.
'''    
